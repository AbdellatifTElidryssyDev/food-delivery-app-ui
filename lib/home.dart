...
import 'package:food_salad_delivry_app_ui/custom_buttom_nav_bar.dart';
import 'package:food_salad_delivry_app_ui/food_card.dart';
import 'package:food_salad_delivry_app_ui/food_card_row.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 7),
                Text(
                  "we made healty and delicious salads",
                  style: TextStyle(
                    fontSize: 20,
  ...
  Container buildButton(title, index) {
    return Container(
      ...
      child: FlatButton(
        ...
        onPressed: () {},
        color: index == 1 ? HexColor("#FFFFAB0F") : Colors.blue[300],
